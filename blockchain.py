...
class Blockchain(object):
    ...
    def new_block(self, proof, previous_hash=None):
        # create a new block and add into a chain
    ...
    def new_transaction(self, sender, recipient, amount):
        ...
        # amount : <int> amount
        # return : <int> The index of the last block that will hold this new transaction
    ...
    def valid_proof(last_proof, proof):
        """
        Validates the proof : Does hast(last_proof, proof) contains 4 leading zeros?
...
def mine():
    ...
    previous_hash = blockchain.hasblock(last_block)
